    ...
    <section class="py-5">
        <div class="container w-100 h-100" style="width: 100%;height: 100%;">
            <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        <h1 style="text-align: center;color: #c2c2c2;font-family: fira code;">UHHH <br>IT'S US THIS TIME</h1>
                        <p class="lead shadow-none" style="text-align: center;color: rgb(194,194,194);font-family: fira code;font-size: 13px;margin: 34px;">Something went terribly wrong...<br>We encountered Error 404.</p>
                    </div>
                </div>
            </div>
        </div>
