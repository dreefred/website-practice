...
<body>
    ...
    <section class="py-5">
        <div class="container w-100 h-100" style="width: 100%;height: 100%;">
            <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        <h1 style="text-align: center;color: #c2c2c2;font-family: fira code;">YOU! <br>ARE NOT A HUMAN</h1>
                        <p class="lead shadow-none" style="text-align: center;color: rgb(194,194,194);font-family: fira code;font-size: 13px;margin: 34px;">You have entered the wrong captcha<br>Please login again.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    Document   : error_6
    Created on : Apr 4, 2024, 10:43:35 AM
    Author     : alvar
--%>
