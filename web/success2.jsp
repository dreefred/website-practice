            ...
            <div class="row pt-5">
                <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto">
                    <div class="text-center">
                        ...
                        <h1 class="fw-bold">Welcome to Active Learning</h1>
        ...
        <div class="container bg-dark py-5">
            <div class="row">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    ...
                    <h3 class="fw-bold">What we can do for your role</h3>
                </div>
            </div>
            <div class="py-5 p-lg-5">
                <div >
                    <form action="PDFSettingServlet" method="POST" class=" <%if(!user.equals("student")){%>row row-cols-1 row-cols-md-2<%}%> mx-auto" style="max-width: 900px;">
                        ...
                        <div class="col mb-5">
                            <div class="card shadow-sm">
                                <div class="card-body px-4 py-5 px-md-5">
                                    ...
                                    <h5 class="fw-bold card-title">Generate&nbsp; Courses Enrolled</h5>
                                    <p class="text-muted card-text mb-4">Generate a list of current course and status of instructors and students along with other pertinent details.</p><button class="btn btn-primary shadow" type="submit" name="r1" value="r1">Generate Report</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col mb-5">
                            <div class="card shadow-sm">
                                <div class="card-body px-4 py-5 px-md-5">
                                    ...
                                    <h5 class="fw-bold card-title">Modify User Information</h5>
                                    <p class="text-muted card-text mb-4">Update user roles and assign courses to a registered user.</p><button class="btn btn-primary shadow" type="submit" name="r5" value="r5">Modify Masterlist</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col mb-5">
                            <div class="card shadow-sm">
                                <div class="card-body px-4 py-5 px-md-5">
                                    ...
                                    <h5 class="fw-bold card-title">Generate User List</h5>
                                    <p class="text-muted card-text mb-4">Generate a list of users their roles in this website.</p><button class="btn btn-primary shadow" type="submit" name="r6" value="r6">Generate Report</button>
                                </div>
                            </div>
                        </div>
                        <div class="col mb-5">
                            <div class="card shadow-sm">
                                <div class="card-body px-4 py-5 px-md-5">
                                    ...
                                    <h5 class="fw-bold card-title">Generate Your Information</h5>
                                    <p class="text-muted card-text mb-4">An option to generate a report of your records.</p><button class="btn btn-primary shadow" type="submit" name="r7" value="r7">Generate Report</button>
                                </div>
                            </div>
                        </div>
                        <div class="col mb-5">
                            <div class="card shadow-sm">
                                <div class="card-body px-4 py-5 px-md-5">
                                    ...
                                    <h5 class="fw-bold card-title">Generate Masterlist</h5>
                                    <p class="text-muted card-text mb-4">Generate a master list of <b>registered</b> users of Active learning.</p><button class="btn btn-primary shadow" type="submit" name="r2" value="r2">Generate Report</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col mb-4">
                            <div class="card shadow-sm">
                                <div class="card-body px-4 py-5 px-md-5">
                                    ...
                                    <h5 class="fw-bold card-title">Generate Courses Handled</h5>
                                    <p class="text-muted card-text mb-4">Generate a list of students and instructors undertaking/ teaching a certain course.</p><button class="btn btn-primary shadow" type="submit" name="r3" value="r3">Generate Report</button>
                                </div>
                            </div>
                        </div>
                        <%}if(user.equals("instructor")){%>
                        <div class="col mb-4">
                            <div class="card shadow-sm">
                                <div class="card-body px-4 py-5 px-md-5">
                                    ...
                                    <h5 class="fw-bold card-title">Generate Feedback Report</h5>
                                    <p class="text-muted card-text mb-4">Generate a list of student feedback rating per instructors</p><button class="btn btn-primary shadow" type="submit" name="r4" value="r4">Generate Report</button>
                                </div>
                            </div>
                        </div>
                        <%}%>
