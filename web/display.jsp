...
<body>
    <%
            ...
            session.setAttribute("CaptchaImage", null);
        ...
        <div class="container py-3">
            <div class="row mb-4 mb-lg-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <p class="fw-bold text-success mb-2">Here is your report. You can also download by clicking <a href="<%=session.getAttribute("Date")%>.pdf">here</a></p>
                    <embed
                        src="<%=session.getAttribute("Date")%>.pdf"
