    ...
    <nav class="navbar navbar-expand-md sticky-top py-3 navbar-dark" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                </ul><a class="btn btn-primary shadow" role="button" href="index.jsp">Back</a>
            </div>
        </div>
    </nav>
    </header>
    <section class="py-5">
        <div class="container w-100 h-100" style="width: 100%;height: 100%;">
            <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        <h1 style="text-align: center;color: #c2c2c2;font-family: fira code;"><br>YOU ARE NOT ALLOWED HERE</h1>
                        <p class="lead shadow-none" style="text-align: center;color: rgb(194,194,194);font-family: fira code;font-size: 13px;margin: 34px;">Something went terribly wrong...<br>Your session may be invalid or you are accessing a restricted page</p>
                    </div>
                </div>
            </div>
        </div>
